...
help:
	@echo "SimExp Build & Release Automation"
	@echo "=================================="
	@echo ""
...
test-release: bump build upload-test
	@echo ""
	@echo "✨ Full test release workflow complete!"
	@echo "   Version updated, built, and uploaded to TestPyPI"
	@echo ""
	@echo "Next steps:"
	@echo "  1. Test installation: pip install -i https://test.pypi.org/simple/ simexp"
	@echo "  2. Verify functionality with: simexp --help"
